...
#define HTTP_MAX_DATA_WAIT 5000  // ms to wait for the client to send the
                                 // request
...
#define AUTO_KALIBRIERUNG \
  0  // 1 = automatische Kalibrierung an (erfordert 7 Tage Dauerbetrieb mit 1h
     // Frischluft pro Tag)
